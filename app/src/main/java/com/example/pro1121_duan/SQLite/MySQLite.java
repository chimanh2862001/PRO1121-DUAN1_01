...
public class MySQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = " CREATE TABLE DangTin(ID NVARCHAR(5) PRIMARY KEY, TieuDe NVARCHAR(50),LoaiPhong NVARCHAR(50),ThanhPho NVARCHAR(20),QuanHuyen NVARCHAR(30),TenDiaDiem NVARCHAR(50),TenDuong NVARCHAR(50),SoNha NVARCHAR(50), " +
                "DienTich NVARCHAR(50), PhongNgu INTEGER, VeSinh INTEGER, Gia NVARCHAR(50), KinhDo DOUBLE, ViDo DOUBLE, MoTa NVARCHAR(225), LienHe NVARCHAR(50)) ";
        ...
        String CREATE_TABLE_Luu  = " CREATE TABLE LuuTin( TieuDe NVARCHAR(50)  PRIMARY KEY,TenDiaDiem NVARCHAR(50),LoaiPhong NVARCHAR(50)," +
                "DienTich NVARCHAR(50), PhongNgu INTEGER, VeSinh INTEGER, Gia NVARCHAR(50)) ";
