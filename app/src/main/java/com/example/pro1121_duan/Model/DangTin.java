...
public class DangTin {
   ...
   // public String Image;
    ...
    public DangTin(String id, String tieuDe, String loaiPhong, String thanhPho, String quanHuyen, String tenDiaDiem, String tenDuong, String soNha, String dienTich, Integer phongNgu, Integer veSinh, String gia, Double kinhDo, Double viDo, String moTa, String lienHe) {
        Id = id;
        TieuDe = tieuDe;
        LoaiPhong = loaiPhong;
        ThanhPho = thanhPho;
