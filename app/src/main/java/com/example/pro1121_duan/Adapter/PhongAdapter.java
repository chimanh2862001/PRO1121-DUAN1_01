    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        imgLuu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Luu tt = new Luu();
                DangTin dt = new DangTin();
                tt.setLoaiPhong(loaiPhong.getText().toString());
                tt.setTieuDe(tieude.getText().toString());
                tt.setTenDiaDiem(diachi.getText().toString());
                tt.setVeSinh(Integer.parseInt(veSinh.getText().toString()));
                tt.setPhongNgu(Integer.parseInt(phongngu.getText().toString()));


                tt.setGia(gia.getText().toString());
                tt.setDienTich(dientich.getText().toString());
